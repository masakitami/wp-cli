...
<main class="l-main -single">
  ...
  <a
    href="https://txbiz.tv-tokyo.co.jp/gaia/vod/post_253046?utm_source=youtube&utm_medium=end&utm_campaign=gaia20th_yt_l1ZRrJp8Cto">外部リンクですよよ</a>
  <a href="<?php echo home_url();?>/test#section01">固定ページのアンカーリンクですよよ</a>
  <a href="<?php echo home_url();?>#section01">ここのページのアンカーリンクですよよ</a>
